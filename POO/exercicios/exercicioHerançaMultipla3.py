...
carro.imprimir_informacoes()   # os valores de todos os atributos do carro
bike.imprimir_informacoes()    # os valores de todos os atributos da bicicleta
moto.imprimir_informacoes()    # os valores de todos os atributos da moto
